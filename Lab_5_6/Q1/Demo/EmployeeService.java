...
public class EmployeeService {
	...
	static {
		emp = new Employee[10];
		count=0;
		emp[count] = new SalariedEmployee(100, "Omkar", "123456", "omkarware003@gmail.com", "CDAC", "Trainer", LocalDate.of(2023,12,30), 35000, 5000);
		emp[++count] =  new ContractEmployee(101, "Anurag", "222333", "anurag@gmail.com", "ACTS", "Floar Cleaning", LocalDate.of(2000, 12,30), 90, 10000);
		emp[++count] =   new Vendor(102, "Nilesh", "444555", "nilesh@gmail.com", "Sunbeam", "abc", LocalDate.of(2002, 12,30), 20, 50000);
	}
